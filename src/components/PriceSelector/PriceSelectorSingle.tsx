...
interface PriceSelectorProps {
  ...
  title: ReactNode
  tokenBase: string | undefined
  tokenQuote: string | undefined
}

const PriceSelectorSingle = ({
  value,
  width,
  locked,
  onUserInput,
    ...
    <CenteringDiv>
      <FocusedOutlineCard pulsing={pulsing} active={active} onFocus={handleOnFocus} onBlur={handleOnBlur} width={width}>
        <AutoColumn gap="6px" >
          ...
          <InputRow>
            <SmallButton>
              <ButtonLabel fontSize="12px" disabled={true}>
                <Minus size={18} />
              </ButtonLabel>
            </SmallButton>
...
export default PriceSelectorSingle
