...
import SetPricesModalHeader from './SetPricesModalHeader'

export default function ConfirmSetPricesModal({
  trade,
  onConfirm,
  onDismiss,
  recipient,
  ...
  // shouldLogModalCloseEvent lets the child SetPricesModalHeader component know when modal has been closed
