...
import MarketOrderModalFooter from './MarketOrderModalFooter'
import MarketOrderModalHeader from './MarketOrderModalHeader'

export default function ConfirmMarketOrderModal({
  trade,
  originalTrade,
  onAcceptChanges,
  allowedSlippage,
  ...
  // shouldLogModalCloseEvent lets the child MarketOrderModalHeader component know when modal has been closed
  ...
  const confirmationContent = useCallback(
    () =>
      swapErrorMessage ? (
        ...
        <ConfirmationModalContent
          title={<Trans>Confirm Market Order</Trans>}
