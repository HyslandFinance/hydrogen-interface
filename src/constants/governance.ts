...
export const COMMON_CONTRACT_NAMES: Record<number, { [address: string]: string }> = {
  [SupportedChainId.ETHEREUM]: {
    [UNI_ADDRESS[SupportedChainId.ETHEREUM]]: 'UNI',
    [TIMELOCK_ADDRESS[SupportedChainId.ETHEREUM]]: 'Timelock',
    [GOVERNANCE_ALPHA_V0_ADDRESSES[SupportedChainId.ETHEREUM]]: 'Governance (V0)',
    [GOVERNANCE_ALPHA_V1_ADDRESSES[SupportedChainId.ETHEREUM]]: 'Governance (V1)',
    [GOVERNANCE_BRAVO_ADDRESSES[SupportedChainId.ETHEREUM]]: 'Governance',
