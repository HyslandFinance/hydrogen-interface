...
const CHAIN_INFO: ChainInfoMap = {
  [SupportedChainId.ETHEREUM]: {
    ...
    docs: 'https://docs.hydrogendefi.xyz/',
    explorer: 'https://etherscan.io/',
    analyticsLink: 'https://analytics.hydrogendefi.xyz/#/',
    label: 'Ethereum',
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    analyticsLink: 'https://analytics.hydrogendefi.xyz/#/optimism/',
    label: 'Optimism',
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    analyticsLink: 'https://analytics.hydrogendefi.xyz/#/arbitrum',
    label: 'Arbitrum',
  ...
  [SupportedChainId.CELO]: {
    ...
    analyticsLink: 'https://analytics.hydrogendefi.xyz/#/celo',
    label: 'Celo',
    logoUrl: celoLogo,
  ...
  [SupportedChainId.BASE]: {
    ...
    analyticsLink: 'https://analytics.hydrogendefi.xyz/#/base/',
    label: 'Base',
    logoUrl: baseLogo,
    statusPage: '',
    helpCenterUrl: '',
  ...
  [SupportedChainId.BASE_GOERLI]: {
    ...
    analyticsLink: 'https://analytics.hydrogendefi.xyz/#/base_goerli/',
    label: 'Base Göerli',
    logoUrl: baseLogo,
    statusPage: '',
    helpCenterUrl: '',
