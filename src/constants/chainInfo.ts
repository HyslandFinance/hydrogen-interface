...
const CHAIN_INFO: ChainInfoMap = {
  [SupportedChainId.MAINNET]: {
    ...
    infoLink: 'https://analytics.hydrogendefi.xyz/#/',
    label: 'Ethereum',
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    infoLink: 'https://analytics.hydrogendefi.xyz/#/optimism/',
    label: 'Optimism',
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://analytics.hydrogendefi.xyz/#/arbitrum',
    label: 'Arbitrum',
  ...
  [SupportedChainId.POLYGON]: {
    ...
    infoLink: 'https://analytics.hydrogendefi.xyz/#/polygon/',
    label: 'Polygon',
  ...
  [SupportedChainId.CELO]: {
    ...
    infoLink: 'https://analytics.hydrogendefi.xyz/#/celo',
    label: 'Celo',
    logoUrl: celoLogo,
