...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.hydrogendefi.xyz', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.hydrogendefi.xyz', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.hydrogendefi.xyz', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.hydrogendefi.xyz', pathname: '/asset.gif' } }, false],
