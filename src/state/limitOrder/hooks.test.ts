...
describe('hooks', () => {
  describe('#queryParametersToLimitOrderState', () => {
    test('ETH to DAI', () => {
      expect(
        queryParametersToLimitOrderState(
          parse(
    ...
    test('does not duplicate eth for invalid output token', () => {
      expect(
        queryParametersToLimitOrderState(parse('?outputCurrency=invalid', { parseArrays: false, ignoreQueryPrefix: true }))
      ).toEqual({
        [Field.INPUT]: { currencyId: 'ETH' },
