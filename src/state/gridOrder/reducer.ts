...
import { Field, PriceField, PairState, DepositState, GridOrderState, replaceGridOrderState, selectCurrencies, typeInput, depositAmountInput } from './actions'

const initialState: GridOrderState = {
    pairs: [{
      typedValueBuyPrice: '',
      typedValueSellPrice: '',
...
export default createReducer<GridOrderState>(initialState, (builder) => (
  builder
    .addCase(
      replaceGridOrderState,
