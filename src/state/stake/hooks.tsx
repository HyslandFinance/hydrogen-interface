...
import { DAI, UNI, USDC_ETHEREUM, USDT, WBTC, WRAPPED_NATIVE_CURRENCY } from '../../constants/tokens'
...
const STAKING_REWARDS_INFO: {
  ...
  1: [
    {
      tokens: [WRAPPED_NATIVE_CURRENCY[SupportedChainId.ETHEREUM] as Token, DAI],
      stakingRewardAddress: '0xa1484C3aa22a66C62b77E0AE78E15258bd0cB711',
    },
    {
      tokens: [WRAPPED_NATIVE_CURRENCY[SupportedChainId.ETHEREUM] as Token, USDC_ETHEREUM],
      stakingRewardAddress: '0x7FBa4B8Dc5E7616e59622806932DBea72537A56b',
    },
    {
      tokens: [WRAPPED_NATIVE_CURRENCY[SupportedChainId.ETHEREUM] as Token, USDT],
      stakingRewardAddress: '0x6C3e4cb2E96B01F4b866965A91ed4437839A121a',
    },
    {
      tokens: [WRAPPED_NATIVE_CURRENCY[SupportedChainId.ETHEREUM] as Token, WBTC],
