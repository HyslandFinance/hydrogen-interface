...
describe('hooks', () => {
  describe('#queryParametersToMarketOrderState', () => {
    test('ETH to DAI', () => {
      expect(
        queryParametersToMarketOrderState(
          parse(
    ...
    test('does not duplicate eth for invalid output token', () => {
      expect(
        queryParametersToMarketOrderState(parse('?outputCurrency=invalid', { parseArrays: false, ignoreQueryPrefix: true }))
      ).toEqual({
        [Field.INPUT]: { currencyId: 'ETH' },
